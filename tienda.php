...
<div class="container-fluid fixed-top px-0">
   ...
   <!-- Inicio cabecera tienda  -->
    <div class="container-fluid bg-imagen">
        <div class="container text-center" style="max-width: 900px;">
            <h1 class="mb-2 bienvenidaTienda text-white" style="margin-top: 80px; font-size: 60px;">Tienda Online Decorarte</h1>
            <p class="mb-5 boldBlack text-uppercase" style="padding-top:20px;">Novedades, decoración, regalos, útiles para el dia a día... <br> ¡Echa un vistazo y no te
                pierdas nada!</p>
        </div>
    </div>
    <!-- Fin cabecera tienda-->
   ...
   <div class="container-fluid gallery px-0" style="margin-top: 3rem; margin-bottom: 5rem; height: 600px;">
    <div class="row g-2">
        <div class="col-md-6 col-lg-4">
            <div class="gallery-item" style="height: 400px;">
                <img src="img/tienda/lamparas-colores-impresion3d.jpg" class="wh-100" alt="lámparas 3D">
                <div class="gallery-content">
                    <div class="gallery-inner pb-5">
                        <a href="articulosTienda/articulosDeco.php" class="h4 h4Hover">Decoración y hogar</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4">
            <div class="gallery-item" style="height: 400px;">
                <img src="img/tienda/figurasTienda.jpg" class="wh-100" alt="imagen">
                <div class="gallery-content">
                    <div class="gallery-inner pb-5">
                        <a href="articulosTienda/articulosHobbies.php" class="h4 h4Hover">Hobbies y figuras</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4">
            <div class="gallery-item" style="height: 400px;">
                <img src="img/tienda/utiles.jpg" class="wh-100" alt="imagen">
                <div class="gallery-content">
                    <div class="gallery-inner pb-5">
                        <a href="articulosTienda/articulosUtiles.php" class="h4 h4Hover">Productos útiles</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-4">
            <div class="gallery-item" style="height: 400px;">
                <img src="img/tienda/escudoFutbol.jpg" class="wh-100" alt="image">
                <div class="gallery-content">
                    <div class="gallery-inner pb-5">
                        <a href="articulosTienda/regalos.php" class="h4 h4Hover">Regalos</a>
                    </div>
                </div>
            </div>
        </div>
