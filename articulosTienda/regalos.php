...
<div class="container-fluid fixed-top px-0">
    ...
    <div class="container-fluid bg-imagen">
        <div class="container text-center" style="max-width: 900px;">
            <h1 class="mb-4 bienvenidaTienda text-white">Regalos</h1>
            <p class="mb-0 boldBlack pb-4">Detalles para todos los gustos y ocasiones, para tu pareja, amigos o familiares, regala Decorarte!</p>
        </div>
    </div>
    <!-- Fin cabecera tienda-->
    ...
    $seleccionProducto = "SELECT * FROM productos WHERE categoria = 'Regalos'";
    ...
    $regalos = $resultadoConsulta->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="text-center item"> 
        <img class="img" src="data:image/jpeg;base64,' . base64_encode($regalo["imagenProducto"]) . '" />
        <div class="details">
            <h5 class="text-dark title">' . $regalo["nombreProducto"] . '</h5>
            <p class="text-dark" style="font-size: 10px;">' . $regalo["descProducto"] . '</p>
            <div class="mb-4">
                <p class="text-dark price" style="font-size: 10px;">
                    Precio: ' . $regalo["precio"] . '€ <br>
                    <button class="btnAdelante btnTienda mt-2">
                        <a style="margin-top: 100px; color: black;" href="../cestaCompra/cartAction.php?action=addToCart&id=' . $regalo["codProducto"] . '">Añadir al carrito</a>
                    </button>
                </p>
            </div>
        </div>
