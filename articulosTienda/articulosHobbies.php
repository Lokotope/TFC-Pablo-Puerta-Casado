...
<head>
    <meta charset="utf-8">
    <title>Decorarte - Hobbies y figuras</title>
...
<div class="container-fluid fixed-top px-0">
    ...
    <div class="container-fluid bg-imagen">
        <div class="container text-center" style="max-width: 900px;">
            <h1 class="mb-4 bienvenidaTienda text-white">Hobbies y figuras</h1>
            <p class="mb-0 boldBlack pb-4">Figuras, maquetas, utensilios y accesorios para tus hobbies favoritos.</p>
        </div>
    </div>
    <!-- Fin cabecera tienda-->
...
$seleccionProducto = "SELECT * FROM productos WHERE categoria = 'Hobbies'";
...
$hobbies = $resultadoConsulta->fetchAll(PDO::FETCH_ASSOC);
...
<div class="contenedorTienda bg-dark"  style="border:solid; border-color: white;">
   ...
   echo '
    <div class="text-center item"> 
        <img class="img" src="data:image/jpeg;base64,' . base64_encode($hobbie["imagenProducto"]) . '" />
        <div class="details">
            <h5 class="text-dark title">' . $hobbie["nombreProducto"] . '</h5>
            <p class="text-dark" style="font-size: 10px;">' . $hobbie["descProducto"] . '</p>
            <div class="mb-4">
                <p class="text-dark price" style="font-size: 10px;">
                    Precio: ' . $hobbie["precio"] . '€ <br>
                    <button class="btnAdelante btnTienda mt-2">
                        <a style="margin-top: 100px; color: black;" href="../cestaCompra/cartAction.php?action=addToCart&id=' . $hobbie["codProducto"] . '">Añadir al carrito</a>
                    </button>
                </p>
            </div>
        </div>
