...
<div class="container-fluid fixed-top px-0">
    ...
    <div class="container-fluid bg-imagen">
        <div class="container text-center" style="max-width: 900px;">
            <h1 class="mb-4 bienvenidaTienda text-white">Decoración y hogar</h1>
            <p class="mb-0 boldBlack pb-4">Decora tu dormitorio, tu espacio de trabajo o cualquier lugar de tu hogar con estos originales productos</p>
        </div>
    </div>
    <!-- Fin cabecera tienda-->
...
$seleccionProducto = "SELECT * FROM productos WHERE categoria = 'Decoracion'";
...
$decoracion = $resultadoConsulta->fetchAll(PDO::FETCH_ASSOC);
...
<div class="contenedorTienda bg-dark"  style="border:solid; border-color: white;">
    <?php
    foreach ($decoracion as $deco) {
     echo '
    <div class="text-center item"> 
        <img class="img" src="data:image/jpeg;base64,' . base64_encode($deco["imagenProducto"]) . '" />
        <div class="details">
            <h5 class="text-dark title">' . $deco["nombreProducto"] . '</h5>
            <p class="text-dark" style="font-size: 10px;">' . $deco["descProducto"] . '</p>
            <div class="mb-4">
                <p class="text-dark price" style="font-size: 10px;">
                    Precio: ' . $deco["precio"] . '€ <br>
                    <button class="btnAdelante btnTienda mt-2">
                        <a style="margin-top: 100px; color: black;" href="../cestaCompra/cartAction.php?action=addToCart&id=' . $deco["codProducto"] . '">Añadir al carrito</a>
                    </button>
                </p>
            </div>
        </div>
