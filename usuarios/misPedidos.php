...
<div class="container-fluid fixed-top px-0">
    ...
    <div class="container-fluid bg-pad2">
        <div class="container-fluid text-center justify-content:center" style="max-width: 900px;">
            ...
            <p class="mb-3 mt-2 boldBlack" style="font-size: 15px">Historial de pedidos <br> Desde aquí podrás controlar tus pedidos.</p>
        </div>
    </div>
    <!-- Fin cabecera -->
    ...
    <!-- Botonera usuario -->
        ...
        <div class="container">
         <?php
            // Preparar la consulta para obtener los pedidos del cliente
            $consultaPedidosUsuario = $conexion->prepare("SELECT * FROM pedidos WHERE idUsuarioPedido = :usuarioPedido");
            
            // Asignar el valor del parámetro
            $consultaPedidosUsuario->bindParam(':usuarioPedido', $_SESSION['Usuario']['idCliente']);
            
            // Ejecutar la consulta
            $consultaPedidosUsuario->execute();
            
            // Obtener los resultados
            $pedidos = $consultaPedidosUsuario->fetchAll(PDO::FETCH_ASSOC);
            ?>
